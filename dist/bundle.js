...
/***/ function(module, exports, __webpack_require__) {
	...
	$(document).ready(function () {
	  ...
	  $('#selector').heapbox({ 'onChange': function onChange() {
	      ...
	      $.ajax({
	        ...
	        if (articleData.length < 1) {
	          ...
	          var nytData = data.results.filter(function (value) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "/*instanews stylesheet*/\n@font-face {\n  font-family: 'open_sans';\n  src: url(" + __webpack_require__(9) + ");\n  src: url(" + __webpack_require__(9) + "?#iefix) format(\"embedded-opentype\"), url(" + __webpack_require__(10) + ") format(\"woff2\"), url(" + __webpack_require__(11) + ") format(\"woff\"), url(" + __webpack_require__(12) + ") format(\"truetype\"), url(" + __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../assets/fs-fonts/opensans-bold-webfont.svg\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())) + "#open_sansbold) format(\"svg\");\n  font-weight: bold;\n  font-style: normal; }\n\n@font-face {\n  font-family: 'open_sans';\n  src: url(" + __webpack_require__(13) + ");\n  src: url(" + __webpack_require__(13) + "?#iefix) format(\"embedded-opentype\"), url(" + __webpack_require__(14) + ") format(\"woff2\"), url(" + __webpack_require__(15) + ") format(\"woff\"), url(" + __webpack_require__(16) + ") format(\"truetype\"), url(" + __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../assets/fs-fonts/opensans-bolditalic-webfont.svg\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())) + "#open_sansbold_italic) format(\"svg\");\n  font-weight: bold;\n  font-style: italic; }\n\n@font-face {\n  font-family: 'open_sans';\n  src: url(" + __webpack_require__(17) + ");\n  src: url(" + __webpack_require__(17) + "?#iefix) format(\"embedded-opentype\"), url(" + __webpack_require__(18) + ") format(\"woff2\"), url(" + __webpack_require__(19) + ") format(\"woff\"), url(" + __webpack_require__(20) + ") format(\"truetype\"), url(" + __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../assets/fs-fonts/opensans-light-webfont.svg\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())) + "#open_sanslight) format(\"svg\");\n  font-weight: normal;\n  font-style: normal; }\n\n@font-face {\n  font-family: 'open_sans';\n  src: url(" + __webpack_require__(21) + ");\n  src: url(" + __webpack_require__(21) + "?#iefix) format(\"embedded-opentype\"), url(" + __webpack_require__(22) + ") format(\"woff2\"), url(" + __webpack_require__(23) + ") format(\"woff\"), url(" + __webpack_require__(24) + ") format(\"truetype\"), url(" + __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../assets/fs-fonts/opensans-lightitalic-webfont.svg\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())) + "#open_sanslight_italic) format(\"svg\");\n  font-weight: normal;\n  font-style: italic; }\n\nhtml {\n  height: 100%;\n  font-family: 'open_sans', sans-serif;\n  font-size: 16px;\n  color: #ffffff; }\n\nbody {\n  background-color: black;\n  box-sizing: border-box; }\n\nselect {\n  font-size: 30px; }\n\n.loader {\n  height: 10vh;\n  width: 10vh; }\n\n.ajax-loader {\n  text-align: center; }\n\n.header {\n  height: 40vh;\n  margin-top: 30vh; }\n\n.logo-margin {\n  margin: 1vh; }\n  @media (min-width: 600px) {\n    .logo-margin {\n      display: flex;\n      padding-left: 80px;\n      height: auto; } }\n  @media (min-width: 1000px) {\n    .logo-margin {\n      display: flex;\n      flex-direction: flex-start;\n      padding: 0px; } }\n\n.letter {\n  display: flex;\n  justify-content: center;\n  align-content: center;\n  padding: 2vh; }\n  @media (min-width: 600px) {\n    .letter {\n      max-width: 20%; } }\n  @media (min-width: 1000px) {\n    .letter {\n      max-width: 20%; } }\n\n.letter-size {\n  max-width: 200px; }\n  @media (min-width: 600px) {\n    .letter-size {\n      max-width: 80px; } }\n  @media (min-width: 1000px) {\n    .letter-size {\n      max-width: 80px; } }\n\n.container {\n  display: flex;\n  flex-direction: column;\n  align-items: center; }\n  @media (min-width: 600px) {\n    .container {\n      flex-direction: row;\n      justify-content: center; } }\n  @media (min-width: 1000px) {\n    .container {\n      flex-direction: row;\n      justify-content: flex-start; } }\n  .container .options {\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n    line-height: 250%; }\n    @media (min-width: 600px) {\n      .container .options {\n        align-items: flex-start; } }\n  .container .selector {\n    margin-bottom: 10px; }\n\n.caption-font {\n  font-family: \"open_sans\", sans-serif;\n  text-decoration: none;\n  color: #ffffff;\n  line-height: 150%; }\n\n.article {\n  display: flex;\n  height: 50vh;\n  background-size: cover;\n  background-position: 50%; }\n\n.abstract {\n  display: flex;\n  align-items: flex-end;\n  overflow: hidden; }\n  .abstract p {\n    box-sizing: border-box;\n    transform: translateY(100%);\n    background: rgba(0, 0, 0, 0.5); }\n  .abstract:hover p {\n    transform: translateY(0%); }\n\n.article-list {\n  display: flex;\n  flex-wrap: wrap;\n  justify-content: center; }\n  @media (min-width: 600px) {\n    .article-list li {\n      max-width: 50%; } }\n  @media (min-width: 1000px) {\n    .article-list li {\n      max-width: 25%; } }\n\n.footer {\n  display: flex;\n  justify-content: center;\n  align-items: flex-end;\n  height: 10vh;\n  margin: 20px; }\n  @media (min-width: 600px) {\n    .footer {\n      flex-direction: row;\n      justify-content: center; } }\n  @media (min-width: 1000px) {\n    .footer {\n      flex-direction: row;\n      justify-content: flex-start; } }\n\n.footer-font {\n  color: #c2c2c2; }\n", "", {"version":3,"sources":["/./src/src/style.scss"],"names":[],"mappings":"AAAA,wBAAwB;AAGxB;EACI,yBAAyB;EACzB,mCAAQ;EACR,2PAI6E;EAC7E,kBAAkB;EAClB,mBAAmB,EAAA;;AAGvB;EACI,yBAAyB;EACzB,mCAAQ;EACR,6PAI0F;EAC1F,kBAAkB;EAClB,mBAAmB,EAAA;;AAGvB;EACI,yBAAyB;EACzB,oCAAQ;EACR,gQAI+E;EAC/E,oBAAoB;EACpB,mBAAmB,EAAA;;AAGvB;EACI,yBAAyB;EACzB,oCAAQ;EACR,gQAI4F;EAC5F,oBAAoB;EACpB,mBAAmB,EAAA;;AAkCvB;EACE,aAAa;EACb,qCAAqC;EACrC,gBAAgB;EAChB,eA7Ba,EA8Bd;;AAED;EACC,wBAAwB;EACxB,uBAAuB,EACvB;;AAGD;EACE,gBAAgB,EACjB;;AAGD;EACE,aAAa;EACb,YAAY,EACb;;AAED;EACE,mBAAmB,EACpB;;AAGD;EACE,aAAa;EACb,iBAAiB,EAClB;;AAID;EACE,YAAY,EAab;EA/DC;IAiDF;MAII,cAAc;MACd,mBAAmB;MACnB,aAAa,EAQhB,EAAA;EArEC;IAuDF;MAUI,cAAc;MACd,2BAA2B;MAC3B,aAAa,EAEhB,EAAA;;AAGD;EACE,cAAc;EACd,wBAAwB;EACxB,sBAAsB;EACtB,aAAa,EAQd;EA9EC;IAkEF;MAOI,eAAe,EAKlB,EAAA;EApFC;IAwEF;MAUI,eAAe,EAElB,EAAA;;AAKD;EACE,iBAAiB,EAQlB;EA5FC;IAmFF;MAII,gBAAgB,EAKnB,EAAA;EAlGC;IAyFF;MAOG,gBAAgB,EAElB,EAAA;;AAKD;EACE,cAAc;EACd,uBAAuB;EACvB,oBAAoB,EA2BrB;EA/HC;IAiGF;MAMI,oBAAoB;MACpB,wBAAwB,EAuB3B,EAAA;EArIC;IAuGF;MAWI,oBAAoB;MACpB,4BAA4B,EAkB/B,EAAA;EA9BD;IAgBI,cAAc;IACd,uBAAuB;IACvB,oBAAoB;IACpB,kBAAkB,EAMnB;IA1HD;MAiGF;QAsBI,wBAAwB,EAGzB,EAAA;EAzBH;IA4BI,oBAAoB,EACrB;;AAOH;EACE,qCAAqC;EACrC,sBAAsB;EACtB,eAnJa;EAoJb,kBAAkB,EACnB;;AAGD;EACE,cAAc;EACd,aAAa;EACb,uBAAuB;EACvB,yBAAyB,EAC1B;;AAKD;EACE,cAAc;EACd,sBAAsB;EACtB,iBAAiB,EAYlB;EAfD;IAKM,uBAAuB;IACvB,4BAAqB;IACrB,+BAAgB,EACjB;EARL;IAWQ,0BAAqB,EACtB;;AAOP;EACE,cAAc;EACd,gBAAgB;EAChB,wBAAwB,EAYzB;EAzLC;IA0KF;MAOQ,eAAe,EAChB,EAAA;EAxLL;IAgLF;MAYQ,eAAe,EAChB,EAAA;;AAOP;EACE,cAAc;EACd,wBAAwB;EACxB,sBAAsB;EACtB,aAAa;EACb,aAAa,EAad;EAhNC;IA8LF;MAQI,oBAAoB;MACpB,wBAAwB,EAS3B,EAAA;EAtNC;IAoMF;MAcI,oBAAoB;MACpB,4BAA4B,EAG/B,EAAA;;AAED;EACE,eAAe,EAChB","file":"style.scss","sourcesContent":["/*instanews stylesheet*/\n\n//fonts from font-squirrel//\n@font-face {\n    font-family: 'open_sans';\n    src: url('../assets/fs-fonts/opensans-bold-webfont.eot');\n    src: url('../assets/fs-fonts/opensans-bold-webfont.eot?#iefix') format('embedded-opentype'),\n         url('../assets/fs-fonts/opensans-bold-webfont.woff2') format('woff2'),\n         url('../assets/fs-fonts/opensans-bold-webfont.woff') format('woff'),\n         url('../assets/fs-fonts/opensans-bold-webfont.ttf') format('truetype'),\n         url('../assets/fs-fonts/opensans-bold-webfont.svg#open_sansbold') format('svg');\n    font-weight: bold;\n    font-style: normal;\n}\n\n@font-face {\n    font-family: 'open_sans';\n    src: url('../assets/fs-fonts/opensans-bolditalic-webfont.eot');\n    src: url('../assets/fs-fonts/opensans-bolditalic-webfont.eot?#iefix') format('embedded-opentype'),\n         url('../assets/fs-fonts/opensans-bolditalic-webfont.woff2') format('woff2'),\n         url('../assets/fs-fonts/opensans-bolditalic-webfont.woff') format('woff'),\n         url('../assets/fs-fonts/opensans-bolditalic-webfont.ttf') format('truetype'),\n         url('../assets/fs-fonts/opensans-bolditalic-webfont.svg#open_sansbold_italic') format('svg');\n    font-weight: bold;\n    font-style: italic;\n}\n\n@font-face {\n    font-family: 'open_sans';\n    src: url('../assets/fs-fonts/opensans-light-webfont.eot');\n    src: url('../assets/fs-fonts/opensans-light-webfont.eot?#iefix') format('embedded-opentype'),\n         url('../assets/fs-fonts/opensans-light-webfont.woff2') format('woff2'),\n         url('../assets/fs-fonts/opensans-light-webfont.woff') format('woff'),\n         url('../assets/fs-fonts/opensans-light-webfont.ttf') format('truetype'),\n         url('../assets/fs-fonts/opensans-light-webfont.svg#open_sanslight') format('svg');\n    font-weight: normal;\n    font-style: normal;\n}\n\n@font-face {\n    font-family: 'open_sans';\n    src: url('../assets/fs-fonts/opensans-lightitalic-webfont.eot');\n    src: url('../assets/fs-fonts/opensans-lightitalic-webfont.eot?#iefix') format('embedded-opentype'),\n         url('../assets/fs-fonts/opensans-lightitalic-webfont.woff2') format('woff2'),\n         url('../assets/fs-fonts/opensans-lightitalic-webfont.woff') format('woff'),\n         url('../assets/fs-fonts/opensans-lightitalic-webfont.ttf') format('truetype'),\n         url('../assets/fs-fonts/opensans-lightitalic-webfont.svg#open_sanslight_italic') format('svg');\n    font-weight: normal;\n    font-style: italic;\n}\n\n//MEDIA QUERY WITH SASS\n$desktop-width: 1000px;\n$tablet-width: 600px;\n$mobile-width: 480px;\n\n//color variable declaration\n$white: #ffffff;\n$grey: #c2c2c2;\n\n//media query mixin declaration\n@mixin desktop {\n  @media (min-width: $desktop-width) {\n    @content;\n  }\n}\n\n@mixin tablet {\n  @media (min-width: $tablet-width) {\n    @content;\n  }\n}\n\n@mixin mobile {\n  @media (min-width: $mobile-width) {\n    @content;\n  }\n}\n\n//Styling\n//main elements\n\nhtml {\n  height: 100%;\n  font-family: 'open_sans', sans-serif;\n  font-size: 16px;\n  color: $white;\n}\n\nbody {\n background-color: black;\n box-sizing: border-box;\n}\n\n\nselect {\n  font-size: 30px;\n}\n\n//loader image\n.loader {\n  height: 10vh;\n  width: 10vh;\n}\n\n.ajax-loader {\n  text-align: center;\n}\n\n//.header centers the container before the selector is used\n.header {\n  height: 40vh;\n  margin-top: 30vh;\n}\n\n//.logo-margin is added after a category is selected and\n// adjusts the header to go to the top and shrink in size\n.logo-margin {\n  margin: 1vh;\n\n  @include tablet {\n    display: flex;\n    padding-left: 80px;\n    height: auto;\n  }\n\n  @include desktop {\n    display: flex;\n    flex-direction: flex-start;\n    padding: 0px;\n  }\n}\n\n//New York Times Letter with size adjusting using media queries\n.letter {\n  display: flex;\n  justify-content: center;\n  align-content: center;\n  padding: 2vh;\n\n  @include tablet {\n    max-width: 20%;\n  }\n  @include desktop {\n    max-width: 20%;\n  }\n}\n\n\n// .letter-size gets added once a category is selected. \n// edits the size of the letter.\n.letter-size {\n  max-width: 200px;\n\n    @include tablet {\n    max-width: 80px;\n    }\n    @include desktop {\n   max-width: 80px;\n    }\n}\n\n\n//CONTAINER (Letter, text div, and selector container)\n\n.container {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n\n  @include tablet {\n    flex-direction: row;\n    justify-content: center;\n  }\n  \n  @include desktop {\n    flex-direction: row;\n    justify-content: flex-start;\n  }\n\n  .options {   // .option contains the p and selector box\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n    line-height: 250%;\n\n    @include tablet {\n    align-items: flex-start;\n    }\n\n  }\n\n  .selector { //selector container\n    margin-bottom: 10px;\n  }\n}\n\n\n//ARTICLE \n\n//edits font and spacing in the abstract article\n.caption-font{\n  font-family: \"open_sans\", sans-serif;\n  text-decoration: none;\n  color: $white;\n  line-height: 150%;\n}\n\n//edit sizing for the article background image\n.article {\n  display: flex;\n  height: 50vh;\n  background-size: cover;\n  background-position: 50%;\n}\n\n//edits the abstract writing and its background\n//includes hiding abstract and showing p when hovered over any part of the \n//article box\n.abstract {\n  display: flex;\n  align-items: flex-end;\n  overflow: hidden;\n      p {\n      box-sizing: border-box;\n      transform: translateY(100%);\n      background: rgba(0,0,0,0.5);\n    }\n    &:hover { \n      p {\n        transform: translateY(0%);\n      }\n    }\n\n}\n\n//edit sizing and number of articles for each article section\n//1 article per row for mobile, 2 for tablet, 4 for desktop \n.article-list {\n  display: flex;\n  flex-wrap: wrap;\n  justify-content: center;\n\n    @include tablet {\n        li {\n        max-width: 50%;\n      }\n    }\n    @include desktop {\n      li {\n        max-width: 25%;\n      }\n    }\n}\n\n\n//FOOTER\n\n.footer {\n  display: flex;\n  justify-content: center;\n  align-items: flex-end;\n  height: 10vh;\n  margin: 20px;\n  \n  @include tablet {\n    flex-direction: row;\n    justify-content: center;\n  }\n\n\n  @include desktop {\n    flex-direction: row;\n    justify-content: flex-start;\n  }\n\n}\n\n.footer-font {\n  color: #c2c2c2;\n}\n\n\n"],"sourceRoot":"webpack://"}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".heapBox\n{\nclear:both;\ndisplay:inline-block;\nline-height:35px;\nposition:relative;\n}\n\n.heapBox *\n{\nmargin:0;\npadding:0;\noutline: none;\n}\n\n.heapBox.disabled .holder\n{\ncolor:#989898;\n}\n\n.heapBox.disabled .handler\n{\nbackground:url(" + __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../gfx/heapbox_bg.jpg\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())) + ") repeat-x;\n}\n\n.heapBox a{\ntext-decoration:none;\ncolor:#fff;\n}\n\n.heapBox .holder\n{\nwidth:150px;\noverflow:hidden;\nbackground:url(" + __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../gfx/heapbox_bg.jpg\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())) + ") repeat-x;\ntext-indent:20px;\nborder:1px solid #030303;\nborder-right:none;\nheight:35px;\n}\n\n.heapBox .handler\n{\nwidth:25px;\nbackground:url(" + __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../gfx/heapbox_handler_bg.jpg\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())) + ") no-repeat;\nheight:35px;\nborder:1px solid #030303;\nborder-left:none;\n\n}\n\n.heapBox .holder,.heapBox .handler\n{\nfloat:left;\nposition:relative;\nz-index:10;\n}\n\n.heapBox div.heap\n{\ndisplay:none;\nposition:absolute;\nlist-style-type:none;\nleft:0;\nwidth:175px;\ntop:36px;\noverflow:hidden;\nborder:1px solid #000;\nborder-top:none;\n}\n\n.heapBox .heap .heapOptions\n{\ndisplay:block;\noverflow:hidden;\nz-index:20;\nposition:relative;\n}\n\n.heapBox .heap a.sliderUp\n{\ndisplay:block;\nwidth:100%;\nheight:15px;\nbackground:#333 url(" + __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../gfx/slider_arrow_up.png\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())) + ");\nbackground-repeat:no-repeat;\nbackground-position:center center;\nborder-bottom:1px solid #111;\nposition:absolute;\ntop:0px;\nz-index:30;\n}\n\n.heapBox .heap a.sliderDown\n{\ndisplay:block;\nwidth:100%;\nheight:15px;\nbackground:#333 url(" + __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../gfx/slider_arrow_down.png\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())) + ");\nbackground-repeat:no-repeat;\nbackground-position:center center;\nborder-top:1px solid #111;\nposition:absolute;\nbottom:0px;\nz-index:30;\n}\n\n.heapBox .heap .heapOptions .heapOption\n{\nz-index:20;\nposition:relative;\ndisplay:block;\nheight:35px;\n}\n\n.heapBox .heap .heapOptions .heapOption a{\nwidth:100%;\ndisplay:block;\nbackground:url(" + __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../gfx/heapbox_heapitem_bg.jpg\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())) + ") repeat-x;\ntext-indent:20px;\n}\n\n.heapBox .heap .heapOptions .heapOption a:hover{\nbackground:url(" + __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../gfx/heapbox_heapitem_hover_bg.jpg\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())) + ") repeat-x;\n}\n\n.heapBox .heap .heapOptions .heapOption a.selected{\nbackground:url(" + __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../gfx/heapbox_heapitem_hover_bg.jpg\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())) + ") repeat-x;\n}\n\n.heapBox .heap .heapOptions .heapOption a.disabled{\n\tcolor:#777;\n}\n\n.heapBox .heap .heapOptions .heapOption a.disabled:hover{\n\tbackground:url(" + __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"../gfx/heapbox_heapitem_bg.jpg\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())) + ") repeat-x;\n}\n", ""]);
